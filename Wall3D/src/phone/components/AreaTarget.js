$scope.inicio=function(){
  $timeout(function(){
    ...
    $scope.view.wdg['modelItem-13']['color']=$scope.app.mdl['Wall_Helper'].properties['Baliza_Roja_1']
    $scope.view.wdg['modelItem-23']['color']=$scope.app.mdl['Wall_Helper'].properties['Baliza_Verde_1']
    $scope.view.wdg['modelItem-24']['color']=$scope.app.mdl['Wall_Helper'].properties['Baliza_Roja_2']
    $scope.view.wdg['modelItem-25']['color']=$scope.app.mdl['Wall_Helper'].properties['Baliza_Verde_2']
  }
           ,500);
}
...
$scope.$watch("app.mdl['Wall_Helper'].events['DataChange.Baliza_Roja_2']['eventData'][0]['newValue'][0].value", function(){
  if($scope.app.mdl['Wall_Helper'].events['DataChange.Baliza_Roja_2']['eventData'][0]['newValue'][0].value==true){
...
$scope.$watch("app.mdl['Wall_Helper'].events['DataChange.Baliza_Verde_1']['eventData'][0]['newValue'][0].value", function(){
  if($scope.app.mdl['Wall_Helper'].events['DataChange.Baliza_Verde_1']['eventData'][0]['newValue'][0].value==true){
...
$scope.$watch("app.mdl['Wall_Helper'].events['DataChange.Baliza_Verde_2']['eventData'][0]['newValue'][0].value", function(){
  if($scope.app.mdl['Wall_Helper'].events['DataChange.Baliza_Verde_2']['eventData'][0]['newValue'][0].value==true){
    $scope.view.wdg["modelItem-23"]["color"]="rgb(10,254,10)";
  }
  else{
